...
--
-- Host: localhost:3306
-- Generation Time: Apr 10, 2021 at 09:03 AM
...
CREATE TABLE `data_pendaftar` (
  `no` char(16) NOT NULL,
  `jumlah_positif` varchar(20) NOT NULL,
  `jumlah_dirawat` varchar(20) NOT NULL,
  `jumlah_sembuh` varchar(20) NOT NULL,
  `jumlah_meninggal` varchar(20) NOT NULL,
...
INSERT INTO `data_pendaftar` (`no`, `jumlah_positif`, `jumlah_dirawat`, `jumlah_sembuh`, `jumlah_meninggal`, `wilayah`) VALUES
('1', '370.582', '3.463', '357.100', '6.160', 'DKI JAKARTA');
...
('171011450338', 'BADYA PRISAI NUGRAHA', '450338', 'unpam'),
('171011450352', 'ANDIKA JUWITA NUGROHO', '450352', 'unpam'),
('171011450359', 'ASRI SAWITRI', '450359', 'unpam'),
('171011450525', 'ARIF MAULANA', '450525', 'unpam'),
('171011450541', 'ALDI MAULANA', '450541', 'unpam');
